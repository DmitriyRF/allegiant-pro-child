...
function cpotheme_enqueue_custom_front_style_script(){
	...
	wp_register_script('custom-script-chield', get_stylesheet_directory_uri() . '/assets/custom-chield.js', 'jquery', false, true );
	...
	wp_register_style( 'jquery-ui-timepicker', '//cdnjs.cloudflare.com/ajax/libs/timepicker/1.3.5/jquery.timepicker.min.css' , '', '', true );
